...
%   \begin{figure}
%     \centering
%     \includesvg[inkscapelatex=false,width=1.5\textwidth]{assets/a1-fixed.svg}
...
%   \begin{figure}
%     \centering
%     \includesvg[inkscapelatex=false,width=1.45\textwidth]{assets/p1-fixed.svg}
...
%   \begin{figure}
%     \centering
%     \includesvg[inkscapelatex=false,width=1.4\textwidth]{assets/p2-fixed.svg}
...
%   \begin{figure}
%     \centering
%     \includesvg[inkscapelatex=false,width=1.5\textwidth]{assets/uml2.svg}
